...
export const TaskListRow = ({onClick, id, name, description, endDate, priority, status}) => {
            ...
            <tr tabIndex="0" className="focus:outline-none h-16 border border-gray-100 rounded hover:bg-gray-100">
                ...
                <td className="pl-5">
                    <div className="flex items-center">
                        <p className={`text-sm leading-none text-black ml-2 p-2 rounded-full bg-gray-100`}>
                ...
                <td className="pl-5">
                    <div className="flex items-center">
                        <p className={`text-sm leading-none text-gray-50 ml-2 p-2 rounded-full ${
                            priority === "BAJA"
                                ? "bg-green-600"
                                : priority === "MEDIA"
                                    ? "bg-yellow-500"
                            ...
                            {priority.slice(0, 1) + (priority.slice(1, priority.length).toLowerCase())}
                        </p></div>
                </td>
                <td className="pl-5">
                    <div className="flex items-center">
